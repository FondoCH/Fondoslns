...
class Student(db.Model):
    ...
    def __init__(self, name, maths, eng, sci, position, remarks):
        self.name = name
        self.maths = maths
        self.eng = eng
        self.sci = sci
...
def new():
    if request.method == 'POST':
        if not request.form['name'] or not request.form['maths'] or not request.form['eng'] or not request.form['sci']:
            ...
            student = Student(request.form['name'], request.form['maths'], request.form['eng'], request.form['sci'], request.form['position'], request.form['remarks'])
